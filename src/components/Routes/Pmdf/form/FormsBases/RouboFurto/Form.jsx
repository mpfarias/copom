...
import { qtdeIndividuos, opcoesCorVeiculo, caracteristicasOption, opcoesParteDeBaixo, opcoesParteDeCima, opcoesCalcado, opcoesArma, opcoesCabelo, cores } from './Const/Consts';
...
export default function RouboFurto() {
  ...
  const [outraCor, setOutraCor] = useState('');
      ...
      <Grid container sx={{ marginLeft: 1, width: '100%' }} spacing={3}>
        <Grid item style={{ paddingTop: 0 }} xs={12}>
          ...
          <Box sx={{ mt: 2 }} noValidate autoComplete="off">
            <FormLabel id="demo-controlled-radio-buttons-group" style={{ fontWeight: 'bold', fontSize: 18, }}>Qual o tipo de solicitante ?</FormLabel>
            <RadioGroup
              id="solicitante"
              row
          ...
          <Box sx={{ mt: 2 }} noValidate autoComplete="off">
            <FormControl>
              <FormLabel id="demo-row-radio-buttons-group-label" style={{ fontWeight: 'bold', fontSize: 18, }}>Foi Roubo, Furto ou Tentativa ?</FormLabel>
              <RadioGroup
                id="tipo"
                row
                aria-labelledby="demo-row-radio-buttons-group-label"
              ...
              >
                ...
                <FormControlLabel value="tentativaroubado" control={<Radio />} label="Tentativa Roubo" />
                <FormControlLabel value="tentativafurtado" control={<Radio />} label="Tentativa Furto" />
              </RadioGroup>
            </FormControl>
          </Box>
          <Box sx={{ mt: 2 }} noValidate autoComplete="off">
          ...
          <Stack sx={{ width: '100%' }} spacing={2}>
            {(objeto === 'veículo' || objeto === 'transeunte' || objeto === 'estabelecimento comercial' || objeto === 'residência' || objeto ===  '') && (
              <>
                ...
                <Grid item xs={12}>
                  <TextField sx={{ marginBottom: 2, marginRight: 2, width: '80%' }} placeholder="Endereço" fullWidth id="outlined-basic-endereco" onChange={e => handleChange('endereco', e.target.value)} label="Qual o endereço roubo/furto ?" variant="outlined" />
                ...
                <Grid item xs={12}>
                  <TextField sx={{ marginBottom: 1, marginRight: 2, width: '80%' }} type="number" inputProps={{ maxLength: 11 }} onChange={handleTelefoneChange} fullWidth id="outlined-basic-telefone" label="Qual o telefone da vítima ?" name="telefone" variant="outlined" />
                ...
                {objeto === 'veículo' && (
                  <>
                    <Grid item xs={12}>
                      <TextField sx={{ marginBottom: 2, marginRight: 2, width: '80%' }} placeholder="Placa do veículo" fullWidth id="outlined-basic-nome" onChange={e => handleChange('placa', e.target.value)} label="Qual a placa do veículo ?" variant="outlined" />
                    ...
                    <Grid item xs={12}>
                      <TextField sx={{ marginBottom: 2, marginRight: 2, width: '80%' }} placeholder="Marca/Modelo do veículo" fullWidth id="outlined-basic-nome" onChange={e => handleChange('modelo', e.target.value)} label="Qual a marca/modelo do veículo ?" variant="outlined" />
                    ...
                    <Grid item xs={12}>
                      <FormControl>
                        <FormLabel id="cor-veiculo-label" style={{ fontWeight: 'bold', fontSize: 18, }}>Qual a cor do veículo ?</FormLabel>
                        <RadioGroup
                          row
                ...
                <Grid item xs={12}>
                  <FormControl sx={{ width: '80%' }}>
                    <FormLabel sx={{ marginBottom: 2 }} id="demo-controlled-radio-buttons-group" style={{ fontWeight: 'bold', fontSize: 18, }}>Quantos indivíduos eram ?</FormLabel>
                    <RadioGroup
