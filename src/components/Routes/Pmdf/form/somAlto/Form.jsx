...
import CpfInput from '../../../../CpfValidator/CpfValidator';
...
telefone: ${telefone} informa que tem som automotivo no local, pede apoio do DETRAN  `,
  ...
  }, [nome, endereco, telefone, cpf, regiaoAdministrativa, referencia]);
      ...
      <Grid item xs={12}>
        ...
        <CopyToClipboard text={regiaoAdministrativa} onCopy={() => console.log('Cidade copiada!')}>
          <Button variant="contained"
            color="secondary"
            style={{ backgroundColor: '#32CD32', color: '#FFFFFF', marginLeft: '90%' }}><FileCopyIcon />
          </Button>
        </CopyToClipboard>
      </Grid>
